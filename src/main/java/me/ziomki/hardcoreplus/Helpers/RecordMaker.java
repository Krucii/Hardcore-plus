...
import me.ziomki.hardcoreplus.Modules.EntityAirChange.SmallerLungs;
...
public class RecordMaker {
    ...
    public static void addAll() {
        ...
        gui_icon.add(new DifficultiesList(100.0, Material.WATER_BUCKET, ChatColor.AQUA, "Wąskie płuca", "Ilość tlenu pod wodą jest ograniczona", SmallerLungs.class));
        gui_icon.add(new DifficultiesList(5.0, Material.LEATHER_BOOTS, org.bukkit.ChatColor.GREEN, "Łamaga", "Pojawia się rosnąca wraz z wysokością szansa na skręcenie kostki podczas upadku.", BoneBreak.class));
        ...
        gui_icon.add(new DifficultiesList(100.0, Material.ROTTEN_FLESH, ChatColor.AQUA, "Głodne poczwary", "Wszystkie goniące graczy potwory są szybsze.", FasterMonsters.class));
